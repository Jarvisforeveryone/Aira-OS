...
class ChatKeyManager private constructor(private val context: Context) {
    ...
    private val sharedPreferences: SharedPreferences = com.aira.assistant.core.security.SecurePrefs.getEncryptedSharedPreferences(context, "aira_secure_api_keys")
    ...
    fun getNextKey(): String? {
        ...
        val envKey = com.aira.assistant.BuildConfig.GEMINI_API_KEY
