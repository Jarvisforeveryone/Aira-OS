...
object InstantMultiCommandDispatcher {
     ...
     */
    suspend fun dispatch(context: Context, rawInput: String, viewModel: AssistantActionHandler?): MultiCommandDispatchResult? {
     ...
     */
    suspend fun executeSingleClause(context: Context, rawClause: String, viewModel: AssistantActionHandler?): SubCommandResult? {
