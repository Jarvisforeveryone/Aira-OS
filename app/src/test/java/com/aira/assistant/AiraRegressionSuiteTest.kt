...
import com.aira.assistant.data.DatabaseSchema
import com.aira.assistant.core.llm.LlamaCppBrain
import com.aira.assistant.network.stream.SentenceChunker
import com.aira.assistant.service.AiraAccessibilityService
import com.aira.assistant.utils.AiraAudioFocusManager
...
class AiraRegressionSuiteTest {
    ...
    fun regression_AIRA_DB_001_and_002_MigrationsPreserveData() {
        assertEquals(12, DatabaseSchema.DATABASE_VERSION)
        assertTrue(DatabaseSchema.ALL_MIGRATIONS.isNotEmpty())
        assertEquals(11, DatabaseSchema.ALL_MIGRATIONS.size)
    }
